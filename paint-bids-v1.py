...
PAINTER_WAGE = 20  # Average of $18–$22/hour in MN 56001, safe starting point[](https://paintingbusinesspro.com/how-to-estimate-paint-jobs/)
...
MARKUP_PERCENT = 0.45  # 20% profit + 25% overhead (insurance, marketing, etc.)[](https://paintingbusinesspro.com/how-to-estimate-paint-jobs/)
...
# Calculate hours based on square footage and prep level
...
def calculate_costs(sq_ft, scope, prep_level, crew_size):
    ...
    # Material costs
    if scope == "Both Interior and Exterior":
        paint_area = sq_ft * 2  # Double area for both
    else:
        paint_area = sq_ft
...
# Footer
st.markdown("---")
st.markdown("Built with Streamlit for residential painting contractors in Mankato, MN. Assumes average wages and material costs for 56001.")[](https://paintingbusinesspro.com/how-to-estimate-paint-jobs/)
